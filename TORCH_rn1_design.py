...
### local design
# python ~/bin/TORCH_rn1_design.py ~/rosetta/ ~/peptideAmyloid/rnd1_design/model_21403/model_21403.pdb  ~/peptideAmyloid/rnd1_design/designProtocol_RND1.xml  ~/peptideAmyloid/rnd1_design/resfile
