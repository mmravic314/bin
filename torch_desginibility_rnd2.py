...
# input 1: input path to model to evaluate
# input 2: 
# input 3: path to place score file, just text output of success
...
helices = [ inPDB.select( '(not element H) chain %s resnum %s' % (c, selStr( np.arange( 8, 20 ) )) ).copy() for c in ['X', 'Y'] ]
