...
hLen 	= 25.71 ## Global parameter, describing helix used, calculation for PHI	
#
#scl enable python27 'python ~/bin/summarize_paramsScores.py ~/peptideAmyloid/rnd1_scores/ ~/peptideAmyloid/rnd1OsakaModels/  posPaSummary.txt negPaSummary.txt'
#
# scl enable python27 'python ~/bin/summarize_paramsScores.py ~/peptideAmyloid/tmp_PA/ ~/peptideAmyloid/tmp_PA/ posPaSummary.txt negPaSummary.txt'
...
for i in os.listdir( sys.argv[1] ):
	...
	cls = '0' 
	if np.mean( scoreV ) >= 80 or min( scoreV ) >= 50  :
		cls = '1'
